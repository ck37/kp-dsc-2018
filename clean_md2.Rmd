...
#need to import new data for this because the ordering was changed when I imputed the values.  Sorry this is messy!
# sample <- readRDS("./data/impute_md.rds")
# library(daff)
# diff <- differs_from(sample, data)
# 
# 
# impute <- ck37r::impute_missing_values(sample(), type = "standard", verbose = TRUE)
...
#add in the indicators that MD specifies? keep for now
impute <- c("ind_der_deltaeta_jet_jet","ind_der_mass_jet_jet"   , "ind_der_prodeta_jet_jet",  "ind_der_lep_eta_centrality" , "ind_pri_jet_subleading_pt", "ind_pri_jet_subleading_eta" , "ind_pri_jet_subleading_phi")
# Add missingness indicators to task$covariates
(task$covariates <- c(task$covariates, impute))
task$impute <- impute
