...
#NOTE: weight and kaggleweight shouldn't be used to build the classifier, they're sampling weights that were used to over-sample the event data (because the outcome is rare). eventid is the unique row identifier.
